...
function validateUsername() {
   ...
   try {
      // replace with conditional expression                      (DONE)
      /* REPLACED WITH REGULAR EXPRESSION if (unInput.value.length < 4) { */
...
function validatePassword() {
   ...
   try {
      // replace with conditional expression                      (DONE)
      /* REPLACED WITH REGULAR EXPRESSION if (pw1Input.value.length < 8) {*/
...
function validateEmail() {
   ...
   try {
      ...
      ** FIRST REVISION TESTS FOR JUST @ AND . PRESENCE, NOT FULL EXPRESSION
      if (emailInput.value.search(/@/) === -1 || emailInput.value.indexOf(".") === -1) {
      ** SECOND REVISION TESTS FOR @ PRESENCE AND VARIOUS LENGTHS OF .SUFFIX, MULTIPLE EXPRESSIONS FOR .SUFFIX LENGTHS
      if (
      ...
      */
      ...
      // replace with code to convert email address to lowercase  (DONE)
