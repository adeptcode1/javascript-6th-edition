...
/* simulate placeholder text for browsers that don't support the placeholder attribute */
...
/* copy values for Billing address to Deliver address fields */
...
function validatePayment() {
    ...
    try {
        ...
        if (ccNumElement.value === "") {
            // verify that a card number is entered
        ...
        for (var i = 0; i < elementCount; i++) {
            //verify that a expiration month and year are selected
            currentElement = selectElements[i];
            if (currentElement.selectedIndex === -1) {
                currentElement.style.border = "1px solid red";
                fieldsetValidity = false;
        ...
        if (cvvElement.value === "") {
            // verify that a CVV value is entered
...
function validateMessage() {
    ...
    try {
        if (document.getElementById("custom").checked &&
            ...
            throw "Please enter a custom message or uncheck the Custom Message option.";
        } else {
            errorDiv.style.display = "none";
...
function validateCreateAccount() {
    ...
    try {
        ...
        if (!(usernameElement.value === "" && pass1Element.value === ""
            ...
            throw "To create an account, please complete all fields.";
        }
    } catch (msg) {
        errorDiv.innerHTML = msg;
        errorDiv.style.display = "block";
